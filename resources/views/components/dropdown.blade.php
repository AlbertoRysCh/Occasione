...
$classes = ($active ?? false)
            ? 'relative mt-5 items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 text-gray-900  transition'
            : 'relative mt-5 items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900  transition';
@endphp
