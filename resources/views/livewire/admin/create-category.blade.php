    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <input wire:model="createForm.image_banner" accept="image/*" type="file" class="mt-1" name=""
                    id="{{ $rand2 }}">
    ...
    <x-jet-dialog-modal wire:model="editForm.open">
        ...
        <x-slot name="content">
            ...
            <div class="space-y-3">
                ...
                <div>
                    @if ($editImage)
                        <img class="w-full h-64 object-cover object-center" src="{{ $editImage->temporaryUrl() }}"
                            alt="">
                    @else
                        <a href="{{ Storage::url($editForm['image']) }}" target="_blank"
                            class="uppercase underline hover:text-blue-600">
                ...
                <div>
                    @if ($editImage2)
                        <img class="w-full h-64 object-cover object-center" src="{{ $editImage2->temporaryUrl() }}"
                            alt="">
                    @else
                        <a href="{{ Storage::url($editForm['image_banner']) }}" target="_blank"
                            class="uppercase underline hover:text-blue-600">
                            <img class="w-full h-64 object-cover object-center"
                                src="{{ Storage::url($editForm['image_banner']) }}" alt="">
                        </a>
                    @endif
                </div>
                ...
                <div>
                    ...
                    <input wire:model="editImage2" accept="image/*" type="file" class="mt-1" name=""
                        id="{{ $rand2 }}">
